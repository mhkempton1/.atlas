...
const MissionIntelWidget = ({ onLaunchBriefing }) => {
    ...
    if (intel.length === 0) return null; // Don't show if nothing relevant

    return (
        <div className="bg-slate-900/50 border border-purple-500/30 rounded-2xl overflow-hidden mb-6 relative group">
